                    ...
                    <div className="row ">
                                            ...
                                            <div className="tab-create-item">
                                                ...
                                                <fieldset className="propertise">
                                                    ...
                                                    <ul className="propertise-list">
                                                        <li><a href="#">Art<i className="fal fa-times"></i></a></li>
                                                        <li><a href="#">Body type<i className="fal fa-times"></i></a></li>
                                                        <li><a href="#">Face color<i className="fal fa-times"></i></a></li>
                                                    </ul>
                                                </fieldset>
                                                ...
                                                <ul className="collection-list">
                                                    ...
                                                    <li>
                                                        <div className="list">
                                                            ...
                                                            <div className="button-toggle">
                                                                <input  type="checkbox" id="switch2" defaultChecked={true}/>
                                                ...
                                                <div className="bottom-button">
                                                    <a href="#" className="tf-button active">Publish</a>
                                                    <a href="#" className="tf-button">Discard all</a>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <ul className="collection-list">
                                                    <li>
                                                        <div className="list">
                                                            ...
                                                            <div  className="button-toggle">
                                                                <input type="checkbox" id="switch4" defaultChecked={true} />
                                                    ...
                                                    <li>
                                                        <div className="list">
                                                            ...
                                                            <div className="button-toggle">
                                                                <input  type="checkbox" id="switch6" defaultChecked={true}/>
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6">
                            ...
                            <div className="sc-product style1">
                                <div className="top">
                                    <a href="#" className="tag">Sweet Baby #1</a>
