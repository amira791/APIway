                          ...
                          <div className="list">
                                  ...
                                  <div className="bottom">
                                    <div className="details-product">
                                      <label class="checkbox-item">
                                        ...
                                        <span>
                                          I confirm that I own or have rights to
                                          publish this API according to the Hub{" "}
                            ...
                            <div class="widget widget-category sc-product style2">
                              <div>
                                ...
                                <h6> <a href=""><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
