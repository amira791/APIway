                            ...
                            <div id="site-header-inner">                                 
                                <div id="site-logo" className="clearfix">
                                    <div id="site-logo-inner">
                                        <a href="index-2.html" rel="home" className="main-logo">
                                            <img id="logo_header" style={{paddingTop:"5%",translate:"-10%",width:"60%"}} src="assets/images/logo/MAPI_logo_White.png" alt="Image"></img>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div className="header-right">
                                    <span className="user "><svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <mask id="mask1_2981_49321" style={{ WebkitMaskType: 'alpha' }} maskUnits="userSpaceOnUse" x="15" y="10" width="5" height="6">
