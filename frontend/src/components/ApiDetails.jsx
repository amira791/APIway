...
const ApiDetails = () => {
    ...
    const { id } = useParams(); // Get API ID from URL params
    const [apiDetails, setApiDetails] = useState(null);

    
    // useEffect(() => {
    //     // Fetch API details using the API ID
    //     axios.get(`http://127.0.0.1:8000/apis/${id}`)
    //       .then(response => {
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            ...
                            <ul className="breadcrumbs">
                                ...
                                <li>API {Api.api_name} Details</li>
                            </ul>
                            <h4 className="page-title-heading text-6xl mt-4">API {Api.api_name} Details</h4>
                        </div>
                    </div>
                </div>                    
            </section>
                        ...
                        <div className="col-md-12">
                            <div className="tf-item-detail-inner">
                                ...
                                <div className="content">
                                    ...
                                    <p className="except">{Api.description}</p>
                                    ...
                                    <div className="content-bottom">
                                        ...
                                        <div className="button">
                                            ...
                                            <a href="#" className="tf-button">Save for later</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
