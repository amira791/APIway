        ...
        {paymentSuccess ?
          <section className="successful-payment">
            ...
            <div className="success-payment-details">
              <p><strong>Offre sélectionnée :</strong> {name} </p>
              <p><strong>Montant :</strong> {price} </p>
              <p><strong>Date de début d'abonnement : </strong> {subscribed.dateDebut} </p>
              <p><strong>Date de fin d'abonnement : </strong> {subscribed.dateDebut} </p>
            </div>
            <div className="receipt-actions">
              <button onClick={() => handleDownload(subscribed.facture.pdf)} >Télécharger la facture &#11015;</button>
              <button onClick={() => navigate('/services') } >Page des services  &#128462;</button>
            </div>
          </section>
          :
