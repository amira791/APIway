...
import { LineChart, BarChart, PieChart } from '../global_components/Dashboard';
                ...
                <div className="tf-container">
                    <div className="row ">
                        ...
                        <div className="col-xl-9 col-lg-12 col-md-12 overflow-table">
                            ...
                            <h2 className="title-dashboard">Statistics</h2>
                                <div className="history-filter">
                                    ...
                                    <h4 className="title-dashboard">Users Info</h4>
                                    <PieChart />
                                    </div>
                                </div>
                            </div>
