# Generated by Django 4.2.1 on 2024-05-06 18:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(help_text='Brief description of the API', max_length=255)),
        ...
        migrations.AddField(
            model_name='api',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='api_mapi.apicategory', verbose_name='Category'),
        ),
        migrations.AddField(
            model_name='api',
            name='provider',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='api_mapi.fournisseur', verbose_name='Provider'),
        ),
        migrations.CreateModel(
            name='Admin',
            fields=[
