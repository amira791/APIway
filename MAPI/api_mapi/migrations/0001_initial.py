# Generated by Django 5.0.2 on 2024-05-01 13:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('externalDocURL', models.TextField(default='', help_text='External link to more information')),
                ('externalDocDescription', models.TextField(default='', help_text='Brief label for external link')),
            ],
        ),
        migrations.CreateModel(
            name='BaseLink',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='Category', to='api_mapi.apicategory')),
                ('provider', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api_mapi.fournisseur', verbose_name='Provider')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('base_links', models.ManyToManyField(to='api_mapi.baselink', verbose_name='Base Links')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quota_type', models.CharField(choices=[('Daily', 'Daily'), ('Monthly', 'Monthly'), ('Yearly', 'Yearly')], default='', max_length=100)),
                ('quota_limit', models.IntegerField(null=True)),
                ('rate_limit', models.IntegerField(null=True)),
                ('pricingModel', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api_mapi.pricingmodel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('api', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api_mapi.api')),
                ('consumer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api_mapi.consommateur')),
                ('pricing', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api_mapi.tarification')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('example_value', models.CharField(default='', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='api_mapi.typeparam')),
            ],
        ),
    ]
