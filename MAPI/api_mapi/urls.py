...
router.register(r'ticket-responses', TicketResponseView, basename='ticket-responses')
...
urlpatterns = [
    ...
    path('tickets/<int:ticket_pk>/responses/', TicketResponseView.as_view({'get': 'list', 'post': 'create'}), name='ticket-responses'),
