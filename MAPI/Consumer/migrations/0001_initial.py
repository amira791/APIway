# Generated by Django 5.0.5 on 2024-05-07 19:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(help_text='Brief description of the API', verbose_name='Description')),
                ('terms_of_use', models.TextField(help_text='Terms and conditions for API usage', verbose_name='Terms of Use')),
                ...
                ('website', models.URLField(help_text='API website', verbose_name='Website')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Consumer.apicategory', verbose_name='Category')),
                ('provider', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Consumer.fournisseur', verbose_name='Provider')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payload_description', models.TextField(help_text='Payload text', verbose_name='Payload text')),
                ('body_example', models.TextField(help_text='Example of a body', verbose_name='Example')),
                ('endpoint', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='body', to='Consumer.apiendpoint')),
            ],
        ),
        migrations.CreateModel(
            name='APIversion',
            fields=[
                ...
                ('api', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='Consumer.api')),
                ('base_links', models.ManyToManyField(blank=True, to='Consumer.baselink', verbose_name='Base Links')),
                ('functions', models.ManyToManyField(null=True, to='Consumer.functionnality')),
            ],
        ),
        migrations.AddField(
            model_name='apiendpoint',
            name='version',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Consumer.apiversion'),
        ),
        migrations.CreateModel(
            name='APIdocumentation',
            fields=[
                ('id_doc', models.AutoField(primary_key=True, serialize=False)),
                ('apiVersion', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Consumer.apiversion')),
            ],
        ),
        migrations.CreateModel(
            name='PricingModel',
            fields=[
                ...
                ('period', models.CharField(choices=[('Daily', 'Daily'), ('Monthly', 'Monthly'), ('Yearly', 'Yearly')], max_length=100)),
                ('description', models.TextField(help_text='Brief description of the pricing model')),
                ('is_active', models.BooleanField(default=True)),
                ('api', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Consumer.api')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_endpoint', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Consumer.apiendpoint')),
            ],
        ),
        migrations.CreateModel(
            name='Tarification',
            fields=[
                ...
                ('pricingModel', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Consumer.pricingmodel')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Consumer.typetarif')),
            ],
        ),
        migrations.CreateModel(
            name='Abonnement',
            fields=[
                ...
                ('api', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Consumer.api')),
                ('consumer', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Consumer.consommateur')),
                ('pricing', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Consumer.tarification')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_endpoint', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Consumer.apiendpoint')),
                ('type_id', models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, to='Consumer.typeparam')),
            ],
        ),
        migrations.CreateModel(
            name='ApiQueryParam',
            fields=[
                ...
                ('example_value', models.CharField(max_length=255)),
                ('endpoint', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='query_params', to='Consumer.apiendpoint')),
                ('type_id', models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, to='Consumer.typeparam')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('example_value', models.CharField(max_length=255)),
                ('required', models.BooleanField(default=False)),
                ('endpoint', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='headers', to='Consumer.apiendpoint')),
                ('type_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Consumer.typeparam')),
            ],
        ),
    ]
